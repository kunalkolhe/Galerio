      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        ...
        >
          {filteredItems.map((item, index) => (
            ...
            >
              <div 
                className="rounded-xl overflow-hidden bg-surface-1 cinematic-shadow transition-transform duration-400 ease-out group-hover:scale-[1.02] group-hover:-translate-y-1"
              >
